...
const (
	ClientPluginLoad               = "%s plugin and configuration has loaded"
	...
	ClientConfigFileError          = "Error reading \"saga_client.json\" file: %s"
	ClientEndpointNotFoundError    = "No matching endpoint found as %s in \"config.json\""
	ClientConfigFIleUnmarshalError = "Error unmarshalling \"saga_client.json\" file: %s"
